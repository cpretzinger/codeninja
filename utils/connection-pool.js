export class SSEConnectionPool {
    ...
    async addConnection(connection) {
        ...
        if (this.connections.size >= this.config.maxConnections) {
            const error = new (await import('../types/http-transport.js')).ConnectionPoolFullError(this.config.maxConnections, {
 ...
 */
export function createSSEConnection(id, clientInfo, transport, response) {
    const now = new Date();
    return {
        id,
        clientInfo,
 ...
 */
export function validateSSERequest(headers) {
 ...
 */
export function setupSSEHeaders(response) {
